...
export type TeamGame = { id: string; team_id: string; game_id: string; status: "locked" | "unlocked" | "live" | "completed"; points_awarded: number | null; completed_at: string | null; card_picks_granted: number };
